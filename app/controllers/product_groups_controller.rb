class ProductGroupsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to product_groups_path, status: :see_other, notice: "Product group was successfully destroyed." }
  ...
  private
    ...
    def product_group_params
      params.require(:product_group).permit(:company_id, :name, :comment)
    end
end
