...
class CountriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create country" do
    assert_difference("Country.count") do
      post countries_url, params: { country: { company_id: @country.company_id, name: @country.name } }
    end
  ...
  test "should update country" do
    patch country_url(@country), params: { country: { company_id: @country.company_id, name: @country.name } }
